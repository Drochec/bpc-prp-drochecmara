    ...
    */
    ...
    public:
                        ...
                        error_walls_(0)
        {
            ...
            publish_timer_ = create_wall_timer(15ms, std::bind(&CorridorBang::publish_cmd_vel,this));

            decision_timer_ = create_wall_timer(20ms, std::bind(&CorridorBang::state_machine_driving,this));
